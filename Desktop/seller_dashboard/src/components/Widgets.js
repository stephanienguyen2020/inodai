  ...
  return (
    <Card border="light" className="shadow-sm">
      ...
      <Card.Body>
        ...
        <Progress title="Columbia - Poverty Study" color="purple"  percentage={34} />
        <Progress title="MIT - Design System" color="danger" percentage={60} />
        <Progress title="Yale - Bipolar Disorder" color="tertiary" percentage={45} />
        <Progress title="NYU - Racial Bias in AI-Generated Images" color="info" percentage={35} />
        <Progress last title="Harvard - Eye Tracking" color="purple" percentage={34} />
      </Card.Body>
    </Card>
  );
};
      ...
      <Card.Header className="d-flex flex-row align-items-center flex-0">
        <div className="d-block">
          ...
          <small className="fw-bold mt-2">
            <span className="me-2">This Week</span>
            <FontAwesomeIcon icon={percentageIcon} className={`${percentageColor} me-1`} />
        ...
        <div className="d-flex ms-auto">
          ...
          <Button variant="primary" size="sm" className="me-3">Year</Button>
        </div>
      </Card.Header>
      <Card.Body className="p-2">
        <SalesValueChart />
